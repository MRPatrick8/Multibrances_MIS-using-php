						...
						<div class = "x-panel">
						 <table id="datatable" class="table table-striped table-bordered">
							 ...
							 <tbody>
									<?php	
									include 'dbcon.php';								
										$query1=mysqli_query($con,"select * from branch ORDER BY branch_id DESC")or die(mysqli_error($con));
								...
								<tr>
									...
									<td>
										...
										<a href="branch_del.php?id=<?php echo $id;?>" class="btn btn-danger btn-xs"><i class = "fa fa-trash"></i> Delete</a>
