<?php
include("session.php");
$exp_fetched = mysqli_query($con, "SELECT * FROM user WHERE user_id = '$user_id'");
...
if (isset($_POST['save'])) {
    ...
    $sql = "UPDATE stock_user SET firstname = '$fname', lastname='$lname' WHERE id='$id'";
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md">
                                    ...
                                    <input type="username" class="form-control" name="email" id="email" value="<?php echo $username; ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md">
