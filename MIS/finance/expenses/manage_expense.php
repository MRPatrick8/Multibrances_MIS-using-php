    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <a class = "btn btn-info btn-print" href = "expense_report.php"><i class ="glyphicon glyphicon-arrow-left"></i> Report</a>
                <form class="is-pulled-right" method="post" action="expense_export.php">
                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="add_expense.php?edit=<?php echo $row['expense_id']; ?>" class="btn btn-info btn-sm" style="border-radius:0%;">Edit</a>
                                    </td>
                                    <td class="text-center">
