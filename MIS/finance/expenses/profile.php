<?php
include("session.php");
$exp_fetched = mysqli_query($con, "SELECT * FROM user WHERE user_id = '$userid'");
...
if (isset($_POST['save'])) {
    ...
    $sql = "UPDATE user SET name = '$name', username='$username' WHERE user_id='$userid'";
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Full Names" value="<?php echo $name; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
