...
<div class="row w-100" style="padding: 11px">
  ...
  <div class="card-body">
    ...
    <?php if (isset($_POST['get'])) 
      {
        $array2 = mysqli_query($con,"select * from otheraccounts where accountNo = '$_POST[otherNo]'");
        $array3 = mysqli_query($con,"select * from useraccounts where accountNo = '$_POST[otherNo]'");
        {
          if (mysqli_num_rows($array2) > 0) 
          { $row2 = mysqli_fetch_assoc($array2);
            echo "<div class='row'>
                  <div class='col'>
                  <form method='POST'>
                    Account No.
                  ...
                  <div class='col'>
                    Bank Balance
                    <input type='text' class='form-control my-1'  value='Rwf $row2[balance]' readonly required>
          ...
          }elseif (mysqli_num_rows($array3) > 0) {
           $row2 = mysqli_fetch_assoc($array3);
            echo "
            <div class='row'>
                  <div class='col'>
                    ...
                    <input type='text' value='$row2[accountNo]' name='otherNo' class='form-control ' readonly required>
                    Account Holder Name.
                    <input type='text' class='form-control' value='$row2[name]' readonly required>Bank Balance
                    <input type='text' class='form-control my-1'  value='Rwf $row2[balance]' readonly required>
