...
{
  if (!mysqli_query($con,"insert into useraccounts (name,cnic,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[cnic]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
...
{
  mysqli_query($con,"delete from login where id ='$_GET[del]'");
}
    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <td><input type="" name="accountNo"  value="" class="form-control input-sm" required></td>
          <th>Account Type</th>
          <td>
        ...
        <tr>
          ...
          <td>
            <select name="branch" required class="form-control input-sm">
              ...
              <?php 
                $arr = mysqli_query($con,"select * from brnch");
                if ($arr->num_rows > 0)
                {
