...
<?php
		...
		$query=mysqli_query($con,"select * from category where branch_id ='$branch' order by cat_name")or die(mysqli_error());
...
?>
        ...
        <a href="cat_delete.php?id=<?php echo $row['cat_id'];?>"  style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-trash text-red"></i></a>
