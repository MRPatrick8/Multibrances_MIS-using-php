            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <center><h2 class="box-title">DIGITAL AND OFFSET Products List</h2></center>
                </div><!-- /.box-header -->
...
<?php
		...
		$query=mysqli_query($con,"select * from product natural join supplier natural join category where branch_id='$branch' and cat_code=51 order by prod_name")or die(mysqli_error());
