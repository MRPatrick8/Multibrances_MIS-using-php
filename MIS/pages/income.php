...
?>  
        <table class="table">
          <thead>
              <tr>
                <img width="1100" src="../upload/letter.jpg">
              </tr>
              <tr>
                <th><h5><b><?php echo $row['branch_name'];?></b> </h5></th>
              </tr>
              
            </thead>    
        </table>
				  <h5><b>Receivables Report as of <?php echo date("M d, Y",strtotime($start))." to ".date("M d, Y",strtotime($end));?></b></h5>
                  
				  <a class = "btn btn-success btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Print</a>
							<a class = "btn btn-primary btn-print" href = "home.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a> 
              <form class="is-pulled-right" method="post" action="income_export.php">
...
<?php }?>      
      ...
      <th colspan="4">Total Amount</th>
				<td><h4><b><?php echo number_format($pay,2);?></b></h4></td>
			</tr>
	<?php }?>		
...
?>                      
       ...
       <br><br><br><br><br><br>
          ...
          <thead>
              <tr>
                <img width="1100" src="../upload/footer.jpg">
              </tr>
