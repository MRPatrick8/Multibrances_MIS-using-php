					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Mode of Payment</label><br>
								...
								<div class="col-md-6">
									<label class="radio-inline"><input type="radio" name="payment" value="Cheque">Cheque</label>
								</div><br>
                <div class="col-md-6">
                  <label class="radio-inline"><input type="radio" name="payment" value="MoMo Pay">Mobile Money</label>
                </div><br>
						  </div><!-- /.form group -->
					</div>
