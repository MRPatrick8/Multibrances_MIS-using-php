      ...
      <div class="container about-container" data-aos="fade-up" data-aos-delay="200">
        <div class="row">
          ...
          <div class="col-md-6 about-content">
            ...
            <p class="about-text">
              Tabita foundation started in the year of 2021 and since then we have been working together to: 
              -Raise awareness among families about proven techniques and tips to make parenthood and guardianship. 
              -Create a safer world for our children, work together as a whole community towards that world so that our children can have a much more fun and healthier childhood and the most self-discovery period for our adolescents and then we can expect a healthier and productive generation to make positively impactful decisions for our Countries, Continents and the whole world!
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 service-item">
            ...
            <p class="service-description">We make sure that children gets proper educatin by providing them with school fees and required materials to help them in their education.</p>
          </div>
          <div class="col-lg-4 col-md-6 service-item">
            <div class="service-icon"><i class="bi bi-bar-chart"></i></div>
            <h4 class="service-title"><a href="">Health Care</a></h4>
            <p class="service-description">We make sure that children's helth is taken care of by helping them to get health insurence and education about health care services.</p>
          </div>
          <div class="col-lg-4 col-md-6 service-item">
          ...
          <div class="col-lg-4 col-md-6 service-item">
            ...
            <p class="service-description">We support children development by providing child protection against child abuse either verbal,emotional, physical and sexual abuse and give them guidance in case there is a problem.</p>
          </div>
          <div class="col-lg-4 col-md-6 service-item">
            <div class="service-icon"><i class="bi bi-heart"></i></div>
            <h4 class="service-title"><a href="">Love & Belonging</a></h4>
            <p class="service-description">We promote a better love between children and their parents,children and themselves by helping them to achieve self actualisationand increasing their self-esteem,children and their family and children and the society</p>
          </div>
        </div>
      </div>
