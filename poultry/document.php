...
$res = mysql_query("INSERT INTO documents SET title='".$title."', detail='".$detail."', img='".$bgimg."'");
...
$ddaa = mysql_query("SELECT id, title, detail, img FROM documents ORDER BY id");
    echo mysql_error();
...
echo "                                 <tr>
											...
											<td>
<a href=\"img/documents/$data[3]\" class=\"btn btn-info btn-xs\">View</a>
<a class=\"btn btn-danger btn-xs\" href=\"deldoc.php?id=$data[0]\">Delete</a>
";
