...
<?php echo form_hidden('id',$result->id) ?>
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="breed_type" type="text" name="breed_type" value="<?php echo $result->breed_type ?>"  />
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="booking_receipt_no" type="text" name="booking_receipt_no" value="<?php echo $result->booking_receipt_no ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="booking_amount" type="text" name="booking_amount" value="<?php echo $result->booking_amount ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="final_receipt_no" type="text" name="final_receipt_no" value="<?php echo $result->final_receipt_no ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="final_payment" type="text" name="final_payment" value="<?php echo $result->final_payment ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="quantity" type="text" name="quantity" value="<?php echo $result->quantity ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="unit_price" type="text" name="unit_price" value="<?php echo $result->unit_price ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="total" type="text" name="total" value="<?php echo $result->total ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="worker_id" type="text" name="worker_id" value="<?php echo $result->worker_id ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="customer_id" type="text" name="customer_id" value="<?php echo $result->customer_id ?>"  />
                                    <span class="help-inline">
                                   ...
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="approved_worker_id" type="text" name="approved_worker_id" value="<?php echo $result->approved_worker_id ?>"  />
                                    <span class="help-inline">
                                     <?php echo form_error('approved_worker_id'); ?>
                                   </span></div></div>
                                    

                                   <div class="control-group"><label for="date" class="control-label">Date<span class="required">*</span></label>                              
                                   <div class="controls">                              
                                    <input class="input-xlarge" id="date" type="text" name="date" value="<?php echo $result->date ?>"  />
                                    <span class="help-inline">
