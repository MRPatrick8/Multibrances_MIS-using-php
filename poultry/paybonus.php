...
$usid = mysql_query("SELECT id FROM users WHERE username='".$user."'");
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pay Bonus</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
Please select a Category!!!!
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
                    ...
                    <option value="0">Select a Tailor</option>
					<?php
					$ddaa = mysql_query("SELECT id, fullname, salary FROM staff where stafftype=1 ORDER BY id");
						echo mysql_error();
                    ...
                    <input type="hidden" value="4" name="expcat" class="form-control" />
				...
				<script>
						...
						document.getElementById("desc").value = '<?php if($trip) echo('Trip '.$trip. ' -   ');?>' + 'Drivers Tip for  ' + this.options[this.selectedIndex].text;
