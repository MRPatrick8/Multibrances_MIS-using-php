...
$res = mysql_query("UPDATE `income` SET `inccat`='".$inccat."',`description`='".$desc."',`date`='".$date."',`amount`='".$amount."' WHERE id='".$eid."'");
...
<?php
$old = mysql_fetch_array(mysql_query("SELECT inccat, description, date, amount FROM income WHERE id='".$eid."'"));
?>				
					...
					$details = mysql_fetch_array(mysql_query("SELECT title FROM inccat WHERE id='".$old[0]."'"));
