  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
		...
		<li><a href="../batch_flockview.php"><i class="fa fa-paw"></i><span>Batch Flock</span></a></li>
        <li><a href="../egg_productionlist.php"><i class="fa fa-paw"></i><span>Egg Production</span></a></li>
		<li><a href="../hatcherylist.php"><i class="fa fa-paw"></i><span>Hatchery</span></a></li>
        ...
        <li class="nav-parent"><a href="../#"><i class="fa fa-cog"></i> <span> FARM SETTINGS</span></a>
			<ul class="children">
				...
				<li><a href="../batch_noview.php"><i class="fa fa-paw"></i>Batch No</a></li>
