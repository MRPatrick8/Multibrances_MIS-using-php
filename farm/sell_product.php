            ...
            foreach($_SESSION["cart_item"] as $k => $v) {
              if($productByCode["id"] == $k) {
                if(empty($_SESSION["cart_item"][$k]["quantity"])) {
                  $_SESSION["cart_item"][$k]["quantity"] = 0;echo('yes');
                }
                   ...
                   if(isset($_SESSION["cart_item"])){
                    ...
                    <div class="form-row">
                      <div class="col-md-6 mb-10">
                        ...
                        <div class="custom-control custom-radio mb-10">
                          <input type="radio" class="custom-control-input" id="customControlValidation3" name="paymentmode" value="Mobile Money" required>
                          <label class="custom-control-label" for="customControlValidation3">Mobile Money</label>
                        </div>
                        <div class="custom-control custom-radio mb-10">
                          <input type="radio" class="custom-control-input" id="customControlValidation3" name="paymentmode" value="Bank Transfer" required>
                          <label class="custom-control-label" for="customControlValidation3">Bank Transfer</label>
                        </div>
                        <div class="custom-control custom-radio mb-10">
                          <input type="radio" class="custom-control-input" id="customControlValidation3" name="paymentmode" value="Cheque" required>
                          <label class="custom-control-label" for="customControlValidation3">Cheque</label>
                        </div>
                      </div>
