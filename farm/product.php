...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblproducts(CategoryName,ProductName,ProductPrice,damaged,ProductImage)values(:category,:product,:price,:damaged,:image)";
  $query=$dbh->prepare($sql);
  $query->bindParam(':category',$category,PDO::PARAM_STR);
  $query->bindParam(':product',$product,PDO::PARAM_STR);
  $query->bindParam(':price',$price,PDO::PARAM_STR);
  $query->bindParam(':damaged',$damaged,PDO::PARAM_STR);
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <div class="row ">
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="damaged" value=""  class="form-control" id="damaged" required>
                    </div>
                  </div>
            ...
            <div class="card">
              ...
              <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.damaged,tblproducts.ProductImage from tblproducts ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;
                    if($query->rowCount() > 0)
                    {
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td class="text-center"><?php  echo htmlentities($row->damaged);?></td>
