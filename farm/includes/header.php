 <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    ...
    $sql="SELECT * from  tblcompany where developer='Rene'";
    ...
    if($query->rowCount() > 0)
    {
      ...
      {  
        ...
        { 
          ?>
          <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 70px; width: 70px;" src="assets/img/avatars/avatar15.jpg" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: 30px;" src="assets/img/avatars/avatar15.jpg" alt="logo" /></a>
          ...
          <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 70px; width: 70px;" src="companyimages/<?php  echo $row->companylogo;?>" alt=""></a>
