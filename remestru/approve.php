...
<div class="col-sm-9 form-group"><br>
 ...
 <div class=""> </div>
   ...
   <div class="col-md-4">      
    <button class="btn btn-sm btn-block btn-warning" type="button" onclick="window.location.href='approval.php'">
	 <i class="lnr lnr-chevron-left-circle"></i> &nbsp; Retourner </button>         
   </div>
   <form action="approval.php" method="post"><div class="col-md-4">
   <?php echo"<input type='hidden' name='rowid' value='$code'><input type='hidden' name='ville' value='$aville' required>"; ?>
    <button class="btn btn-sm btn-block btn-<?php echo $bx ?>" type="submit" name="approve" <?php echo $dx ?>> 
	Approuver &nbsp; <i class="lnr lnr-checkmark-circle"></i></button>         
   </div></form>
   <div class="col-md-4">      
 ...
 echo"<div class='modal fade' id='exampleModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' 
	aria-hidden='true' style='top:220px;'><div class='modal-dialog' role='document'>
      ...
      </div><form action='approval.php' method='post'>
