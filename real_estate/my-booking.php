...
<?php 
//$useremail=$_SESSION['login'];
 $sql1 = "SELECT tblhouse.himage1 as himage1,tblhouse.location,tblhouse.id as hid,tblhbooking.FromDate,tblhbooking.message,tblhbooking.Status  from tblhbooking join tblhouse on tblhbooking.houseId=tblhouse.id  where tblhbooking.userEmail=:useremail";
...
<li>
                <div class="vehicle_img"> <a href="house_details.php?hid=<?php echo htmlentities($result1->hid);?>"><img src="admin/img/houseimages/<?php echo htmlentities($result1->himage1);?>" alt="image"></a> </div>
                <div class="vehicle_title">
                  <h6><a href="house_details.php?hid=<?php echo htmlentities($result1->id);?>"> <?php echo htmlentities($result1->location);?></a></h6>
                  <p><b>From Date:</b> <?php echo htmlentities($result1->FromDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Pending</a>
            <div class="clearfix"></div>
                ...
                <?php } ?>
       <div style="float: left"><p><b>Message:</b> <?php echo htmlentities($result1->message);?> </p></div>
              </li>
              <?php }} ?>
