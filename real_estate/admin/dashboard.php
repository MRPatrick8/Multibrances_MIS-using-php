									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
			<?php 
			$sql8 ="SELECT id from tblhbooking ";
			$query8= $dbh -> prepare($sql8);
			$query8->execute();
			$results8=$query8->fetchAll(PDO::FETCH_OBJ);
			$bookings8=$query8->rowCount();
			?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bookings8);?></div>
													<div class="stat-panel-title text-uppercase">Total House Bookings </div>
												</div>
											</div>
											<a href="manage_hbookings.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
