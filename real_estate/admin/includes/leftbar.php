...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
				...
				<li><a href="#"><i class="fa fa-sitemap"></i> Houses</a>
					<ul>
						<li><a href="post_house.php">Post a House</a></li>
						<li><a href="manage_houses.php">Manage Houses</a></li>
					</ul>
				</li>
				<li><a href="manage-bookings.php"><i class="fa fa-users"></i> Manage Car Booking</a></li>
				<li><a href="manage_hbookings.php"><i class="fa fa-users"></i> Manage House Booking</a></li>
