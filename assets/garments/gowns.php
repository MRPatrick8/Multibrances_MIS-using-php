        ...
        <ul>
         ...
         <li class="dropdown"><a href="#"><span>Portfolio</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="active"><a href="gowns.php">Gowns</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 pt-4 pt-lg-0 order-1 order-lg-2 content" data-aos="fade-right">
            <p class="fst-italic">Different Gowns for graduation ceremonies available at T-KAY Garment.
            </p>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-1 order-lg-2 content" data-aos="fade-left">
            <img src="assets/img/portfolio/121.jpg">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="150">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              <!-- <h4>Cards 2</h4>
              <p>Cards</p> -->
              <a href="assets/img/portfolio/122.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              <!-- <h4>Card 3</h4>
              <p>Card</p> -->
              <a href="assets/img/portfolio/141.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-Branding">
            ...
            <div class="portfolio-info">
              <!-- <h4>Branding 2</h4>
              <p>Branding</p> -->
              <a href="assets/img/portfolio/142.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-Branding">
            ...
            <div class="portfolio-info">
              <!-- <h4>Branding 3</h4>
              <p>Branding</p> -->
              <a href="assets/img/portfolio/143.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"><i class="bx bx-plus"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-Branding">
            ...
            <div class="portfolio-info">
              <!-- <h4>Branding 3</h4>
              <p>Branding</p> -->
              <a href="assets/img/portfolio/5.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"><i class="bx bx-plus"></i></a>
