    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:600px;float: left; height:400px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:600px;height:350px;overflow:hidden;">
            ...
            <div>
                ...
                <div u="thumb">Large format printing
                </div>
            </div>
            <div>
                <img data-u="image" src="img/45.jpg" />
                <div u="thumb">3D Printing
                </div>
            </div>
            <div>
                <img data-u="image" src="img/4.jpg" />
                <div u="thumb">Digital Printing
                </div>
            </div>
            <div>
                <img data-u="image" src="img/5.jpg" />
                <div u="thumb">Branding
                </div>
            </div>
            <div>
                <img data-u="image" src="img/6.jpg" />
                <div u="thumb">Offset Printing
                </div>
            </div>
            <!-- <div>
            ...
            <div>
                ...
                <div u="thumb">Print media
                </div>
            </div>
            
        </div>
        <!-- Thumbnail Navigator -->
        <div u="thumbnavigator" style="position:absolute;bottom:0px;left:0px;width:600px;height:60px;color:#000;overflow:hidden;cursor:default;background-color:rgba(3, 196, 235,0.3);">
            <div u="slides">
                <div u="prototype" style="position:absolute;top:0;left:0;width:600px;height:50px;">
