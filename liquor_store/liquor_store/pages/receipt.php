...
?>    
                   ...
                   <table class="table">
                    <thead>
                      <tr>
                        <!-- <img width="1100" src="../upload/letter.jpg"> --><center><h2 style="font-weight: 600"><?php echo $branch_name;?></h2></center>
                      </tr>
                      <tr>
...
<?php }?>					
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-right"><b>TOTAL AMOUNT DUE</td>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-right"><b>18% VAT</b></td>
                        <td style="text-align:right"><b><?php //echo number_format($vat,2);?></b></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td class="text-right"><b>Extra</b></td>
                      ...
                      <!--<tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-right"><b>Mode of Payment</b></td>
                        <td style="text-align:right"><b><?php //echo $row['modeofpayment'];?></b></td>
                      </tr>-->
                      <tr>
                        <th>Prepared by:</th>
                        <th></th>
