        ...
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-primary" href="customers_add.php" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-plus text-blue"></i></a>
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                 ...
                 <form class="is-pulled-right" method="post" action="customer_export.php">
...
?>
        ...
        <a href="cust_del.php?id=<?php echo $row['cust_id'];?>"  style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-trash text-red"></i></a>
	  ...
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="customer_update.php" enctype='multipart/form-data'>
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Names</label>
					<div class="col-lg-9">
						<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['cust_id'];?>" required>  
						<input type="text" class="form-control" id="name" name="last" value="<?php echo $row['names'];?>" required>  
					</div>
				</div>
	
        <div class="form-group">
          <label class="control-label col-lg-3" for="file">Email</label>
          <div class="col-lg-9">
              <input class="form-control" type="email" name="email" id="email" required value="<?php echo $row['email'];?>">  
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-3" for="file">TIN</label>
          <div class="col-lg-9">
              <input class="form-control" type="tin" name="tin" id="tin"  value="<?php echo $row['tin'];?>">  
          </div>
        </div>  			
				<div class="form-group">
