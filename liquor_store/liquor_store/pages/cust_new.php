                    ...
                    <div class="col-md-6">  
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control pull-right" id="names" name="names" placeholder="Full Names" required>
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group col-sm-8">
                          <input type="email" class="form-control pull-right" id="email" name="email" placeholder="Customer Email">
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
                    <div class="col-md-6">
                ...
                <form method="post" action="cash_transaction.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      ...
                      <?php
                       include('../dist/includes/dbcon.php');
                        $query2=mysqli_query($con,"select * from customer where branch_id='$branch' order by names")or die(mysqli_error());
                          while($row2=mysqli_fetch_array($query2)){
                      ?>
            <option value="<?php echo $row2['cust_id'];?>"><?php echo $row2['names'];?></option>
          <?php }?>
                    </select>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
