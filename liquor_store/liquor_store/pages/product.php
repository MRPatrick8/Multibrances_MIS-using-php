            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <center><h2 class="box-title">Product List</h2></center>
                  <form class="is-pulled-right" method="post" action="export_product.php">
...
<?php
		...
		$query=mysqli_query($con,"select * from product natural join supplier natural join category where branch_id='$branch' order by serial")or die(mysqli_error());
...
?>
        ...
        <a href="prod_delete.php?id=<?php echo $row['prod_id'];?>"  style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-trash text-red"></i></a>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="serial" disabled value="<?php echo $row['serial'];?>" required>  
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="desc" value="<?php echo $row['prod_desc'];?>" required>  
					...
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="supplier" required>
					      ...
					      <?php
							...
							$query2=mysqli_query($con,"select * from supplier where branch_id= '$branch'")or die(mysqli_error());
              ...
              $queryc=mysqli_query($con,"select * from category where branch_id= '$branch' order by cat_name")or die(mysqli_error());
