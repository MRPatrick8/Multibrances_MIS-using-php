              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  $cid=$_REQUEST['cid'];
								...
								?>
										<option value="<?php echo $row['prod_id'];?>"><?php echo $row['prod_name']."(".$row['prod_desc'].")"." Available(".$row['prod_qty'].")";?></option>
								  <?php }?>
								</select>
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Amount Due</label>
								...
								<input type="text" style="text-align:right" class="form-control" id="amount_duee" name="amount_due" placeholder="Amount Due" value="<?php echo number_format($grand,2);?>" readonly>
							
						  </div><!-- /.form group -->
              
						 
              <div class="form-group" id="tendered">
                <label for="date">Amount Tendered</label><br>
