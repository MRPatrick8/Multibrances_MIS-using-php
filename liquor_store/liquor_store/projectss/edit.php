...
$query = 'SELECT * FROM project
              WHERE
              project_id ='.$_GET['id'] and 'project_id ='.$branch;
                  ...
                  <h2>Edit Project</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="edit1.php">
                            ...
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Project Name" name="project_name" value="<?php echo $i; ?>">
                            </div>
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Client Name" name="client_name" value="<?php echo $a; ?>">
                            </div> 
                            <div class="form-group">
                              <input type="tel" class="form-control" placeholder="Contact" name="contact" value="<?php echo $b; ?>">
                            </div> 
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Address" name="address" value="<?php echo $c; ?>">
                            </div> 
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Amount Paid" name="amount_paid" value="<?php echo $d; ?>">
                            </div>
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Amount Due" name="amount_due" value="<?php echo $e; ?>">
                            </div>
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Assigned to" name="assign" value="<?php echo $f; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <input type="date" class="form-control" placeholder="Due Date" name="due_date" value="<?php echo $h; ?>">
                            </div>
