    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="manage_projects.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="container-fluid">
                <h3 class="mt-4 text-center">Projects Report</h3>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">      
                        <div class="table-responsive">
                            <center><h2>List of all Projects</h2></center>
