...
<head><meta charset="euc-jp">
 ...
 <title>THIRST OFF STORE -Order on WhatsApp</title>
...
var payNote = '*182*1*1*0786642086#';
var lang = 'en';
var perC = "0%";
perC = cleanP(perC);
...
$(document).ready(function(){
    ...
    $catTab.append('<li><a style="color: #5e0808;" href="#' + catArray[i].replace(/\s+/g,"-") + '">' + catArray[i] + '</a></li>');
    });
...
input[type=radio]{padding-right: 5px;}.rlabel{color:#5e0808;display:inline-block;cursor:pointer;font-weight:700;padding:5px 15px}
.wohide {
...
<div class="media-left"><img src="images/logo.jpg" width="170"></div>
<div class="media-content">

<h1 class='title has-text-black'>THIRST OFF STORE</h1>
<h2 class='subtitle has-text-black' style="margin-top: 5px;">KICUKIRO <br>Kigali-Rwanda <br>Phone: 0786642086 </h2>
</div>
</div></div>
</section>
...
$.each(cartArray, function (i) {
if(cartArray[i][1]>0){
document.getElementById('wocart').innerHTML += '<div class="panel-tabs is-fullhd is-size-6" style="align-items: flex-start;"> <a class="is-pulled-left" style="border:0; color: #5e0808; onClick="updateC(\''+ cartArray[i][0] + '\',-1,'+ cartArray[i][1] + ');"><i class="far fa-2x fa-minus-square"></i></a><span style="width:200px;padding:8px 2px;">' + '<b class="tag is-medium is-light is-rounded">'+ cartArray[i][1] + '</b> x '+ cartArray[i][0] + '</span> <a class="is-pulled-right" style="border:0;color: #5e0808;" onClick="updateC(\''+ cartArray[i][0] + '\',1,'+ cartArray[i][1] + ');"><i class="far fa-2x fa-plus-square"></i></a> </div><!--hr style="margin: 1rem 0;"/-->';
...
var wlink = "https://api.whatsapp.com/send?phone=250786642086&text=Thanks for ordering at "+" (THIRST OFF)%0A%0A" + urlencode(cartM) + "%0APayable: RWF " + amtPayable + "%0A";
...
<footer class="footer">
 ...
 <p class="copyright">copyright &copy; 2022 <a target="_blank" href="http://www.mshop.rw">mshop.rw</a></p>
  </div>
</footer>
