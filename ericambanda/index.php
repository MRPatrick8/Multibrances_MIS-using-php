...
<head><meta charset="euc-jp">
 ...
 <title>Erica MBANDA -Order on WhatsApp</title>
...
<script>
var view = [
{"Item":"POLO Ralph Lauren","Category":"PERFUME","Caption":"125 ml eau de perfum","ItemImageURL":"images/1.jpg","Price":"80,000","Veg":"","Available":"Yes"},
{"Item":"VERSACE Crystal Noir","Category":"PERFUME","Caption":"90 ml eau de toilette","ItemImageURL":"images/2.jpg","Price":"80,000","Veg":"","Available":"Yes"},
{"Item":"La Vie est belle","Category":"PERFUME","Caption":"100 ml eau de perfum","ItemImageURL":"images/3.jpg","Price":"80,000","Veg":"","Available":"Yes"},
{"Item":"HUGO Boss","Category":"PERFUME","Caption":"75 ml eau de perfum","ItemImageURL":"images/4.jpg","Price":"80,000","Veg":"","Available":"Yes"}
...
var payNote = '*182*1*1*0783049205#';
var lang = 'en';
var perC = "0%";
perC = cleanP(perC);
...
$(document).ready(function(){
    ...
    $catTab.append('<li><a style="color: #E30713;" href="#' + catArray[i].replace(/\s+/g,"-") + '">' + catArray[i] + '</a></li>');
    });
...
input[type=radio]{padding-right: 5px;}.rlabel{color:#E30713;display:inline-block;cursor:pointer;font-weight:700;padding:5px 15px}
.wohide {
...
<div class="media-left"><img src="images/logo.jpg" width="200"></div>
<div class="media-content">

<h1 class='title has-text-black'>Erica MBANDA</h1>
<h2 class='subtitle has-text-black' style="margin-top: 5px;">Kigali-Rwanda <br>Phone: 0783049205 </h2>
</div>
</div></div>
</section>
...
$.each(cartArray, function (i) {
if(cartArray[i][1]>0){
document.getElementById('wocart').innerHTML += '<div class="panel-tabs is-fullhd is-size-6" style="align-items: flex-start;"> <a class="is-pulled-left" style="border:0; color: #E30713; onClick="updateC(\''+ cartArray[i][0] + '\',-1,'+ cartArray[i][1] + ');"><i class="far fa-2x fa-minus-square"></i></a><span style="width:200px;padding:8px 2px;">' + '<b class="tag is-medium is-light is-rounded">'+ cartArray[i][1] + '</b> x '+ cartArray[i][0] + '</span> <a class="is-pulled-right" style="border:0;color: #E30713;" onClick="updateC(\''+ cartArray[i][0] + '\',1,'+ cartArray[i][1] + ');"><i class="far fa-2x fa-plus-square"></i></a> </div><!--hr style="margin: 1rem 0;"/-->';
...
var wlink = "https://api.whatsapp.com/send?phone=250783049205&text=Thanks for ordering your Perfume at "+" (Erica MBANDA)%0A%0A" + urlencode(cartM) + "%0APayable: RWF " + amtPayable + "%0A";
...
if (wlink !== "") {
    ...
    wlink += "%0A%0AYour Order Will be delivered to you shortly!%0A%0A";
}
...
<footer class="footer">
 ...
 <p class="copyright">copyright &copy; 2023 <a target="_blank" href="http://www.mshop.rw">mshop.rw</a></p>
  </div>
</footer>
